...
public class LoginApi extends BaseApi {
     ...
     */
    public void logon(String name, String password, NetworkCallback<LoginModel> networkCallback) {
        Call<LoginModel> call = RetrofitClient.getInstance()
     ...
     * @param networkCallback 回调接口
     */
    public void register(String name, String password, String registerTime, NetworkCallback<LoginModel> networkCallback) {
        Call<LoginModel> call = RetrofitClient.getInstance()
                .create(BASE_URL, LoginService.class)
