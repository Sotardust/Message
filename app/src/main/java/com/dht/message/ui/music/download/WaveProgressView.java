...
public class WaveProgressView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        waveWidth = typedArray.getDimension(R.styleable.WaveProgressView_wave_width, dip2px(context, 15));
        ...
        secondWaveColor = typedArray.getColor(R.styleable.WaveProgressView_second_wave_color, getResources().getColor(R.color.orange));
        typedArray.recycle();
